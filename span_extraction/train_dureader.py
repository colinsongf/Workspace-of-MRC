...
def parse_args():
    ...
    path_settings.add_argument('--train_files', nargs='+',
                               default=['../data/preprocessed/trainset/merge.train.json'],
                               help='list of files that contain the preprocessed train data')
    path_settings.add_argument('--dev_files', nargs='+',
                               default=['../data/preprocessed/devset/merge.dev.json'],
                               help='list of files that contain the preprocessed dev data')
    path_settings.add_argument('--test_files', nargs='+',
                               default=['../data/preprocessed/test1set/merge.test1.json'],
...
def prepare(args):
    ...
    bert_vocab_list = []
    with open('../data/chinese_L-12_H-768_A-12/vocab.txt', encoding='utf-8', mode='r') as f:
        bert_vocab_list = f.readlines()

    # for word in brc_data.word_iter('train'): 
    for word in bert_vocab_list:
        vocab.add(word)
