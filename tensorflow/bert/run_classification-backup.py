...
flags.DEFINE_string("train_file", "train-new.txt", " train data file name")
flags.DEFINE_string("dev_file", "test-14k.txt", " dev data file name")
flags.DEFINE_string("test_file", "test-14k.txt", " test data file name")
