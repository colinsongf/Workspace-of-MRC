...
def context_question_text_preprocess(cnt_max_len, qn_max_len):
    ...
    """
    # file path name
    file_train_context = '../data/SQuADv1.1/train.context'
    file_train_question = '../data/SQuADv1.1/train.question'
    file_dev_context = '../data/SQuADv1.1/dev.context'
    file_dev_question = '../data/SQuADv1.1/dev.question'
    file_train_span = '../data/SQuADv1.1/train.span'
    file_dev_span = '../data/SQuADv1.1/dev.span'
    ...
    embedding_matrix = zeros((vocab_size, 300))  # Hyperparameter
